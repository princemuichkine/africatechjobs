    ...
    <div className="p-4 space-y-6 overflow-auto flex-1">
      ...
      {activeFilterCount > 0 && (
        <Button
          ...
          className="w-full h-9 bg-pink-50 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300 hover:bg-pink-100 dark:hover:bg-pink-900/40 hover:text-pink-800 dark:hover:text-pink-200 border border-pink-200 dark:border-pink-800"
        >
          Clear all filters
        </Button>
      )}
