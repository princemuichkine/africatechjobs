            ...
            <div className="flex flex-col max-w-screen-md mx-auto px-6 py-12 pb-32">
                ...
                <div className="relative pt-20 md:pt-20 mb-12 text-center">
                    ...
                    >
                        ...
                        using afritechjobs.com, you agree to these terms.
                    </motion.p>
                </div>
                ...
                >
                    ...
                    <section>
                        ...
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                            afritechjobs.com is Africa&apos;s premier tech job board platform that connects
                            talented developers, designers, and tech professionals with leading African
                            companies and startups. Our platform aggregates daily updated, high-quality
                            tech job opportunities across the continent.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                            ...
                            may provide usage-based billing for additional services. Prices
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white">Trials</h2>
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white">Cancellations</h2>
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                    ...
                    <section>
                        ...
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                            Our goal is to provide a reliable job board experience.
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white">Prohibited uses</h2>
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white">Changes to terms</h2>
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
