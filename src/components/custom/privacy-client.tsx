                ...
                >
                    <section>
                        ...
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight mb-4">
                            ...
                            when you create an account, post job listings, apply for jobs,
                            or contact us for support. This includes personal details,
                            company information, and communication preferences.
                        </p>
                        <ul className="list-disc pl-6 space-y-2 text-foreground/90 text-base leading-relaxed tracking-tight">
                            <li>
                                ...
                                basic profile details you choose to provide.
                            </li>
                            <li>
                                Job content: job listings, applications, resumes,
                                and documents you upload through our platform.
                            </li>
                            <li>
                    ...
                    <section>
                        ...
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                            ...
                            processor, not by afritechjobs.com. We receive limited information
                    ...
                    <section>
                        ...
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight mb-4">
                            ...
                            us to deliver personalized and effective job matching
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-foreground/90 text-base leading-relaxed tracking-tight">
                            ...
                            <li>
                                Match job seekers with relevant opportunities and companies
                    ...
                    <section>
                        ...
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                            ...
                            enhance your experience (for example, job recommendations,
                            candidate matching, and content moderation). These systems
                            process the content you provide to deliver the requested
                            functionality and improve our service quality.
                        </p>
                    </section>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white">Data security</h2>
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white">Data retention</h2>
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white">Your rights</h2>
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white">Contact</h2>
                        <p className="text-foreground/90 text-base leading-relaxed tracking-tight">
