...
export const metadata = {
  title: "Advertise on Africa Tech Jobs",
  description:
    "Reach over 120,000 developers monthly and showcase your product or service on Africa Tech Jobs, the community-driven platform for tech jobs in Africa.",
};
        ...
        <div className="space-y-12 mt-10">
          <section>
            ...
            <p className="text-[#878787] leading-relaxed text-sm">
              Africa Tech Jobs attracts over{" "}
              <a
          ...
          <section>
            ...
            <p className="text-[#878787] leading-relaxed text-sm">
              ...
              interest in tech jobs in Africa and workflow optimization.
              optimization.
              <br />
              <br />
              View our{" "}
